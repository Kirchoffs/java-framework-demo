...
import org.syh.demo.springai.toolcalling.model.TicketRequest;
...
public class HelpDeskTools {
    ...
    public String createTicket(
        ...
        LOGGER.info("Creating a support ticket for user {} with issue {}", username, ticketRequest.issue());
    ...
    @Tool(name = "getTicketStatus", description = "Fetch the status of the open tickets based on the given username")
